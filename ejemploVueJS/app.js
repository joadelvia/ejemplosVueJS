//Creamos una nueva instancia de Vue asociada al div con id app  
  new Vue({
    ...
    // Aquí utilizamos el hook computed. Más info en https://elabismodenull.wordpress.com/2017/05/05/vuejs-el-ciclo-de-vida-de-un-componente/
    computed: {
      // Esta función recorre los equipos que hemos obtenido de la API y le añade un valor la url de la imagen
      // del escudo del equipo que hemos obtenido gracias a https://gist.github.com/jerhinesmith/258eab7a892c87769115
      processedTeams() {
